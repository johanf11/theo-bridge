...
// Alias of /theo-api-pay for plugins that distinguish bank-wire settlement
// from Stellar settlement. The quote already encodes the destination
// (Owlting omnibus address for bank-wire quotes), so this delegates to the
// same execution path as /theo-api-pay.
