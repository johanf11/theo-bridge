...
import {
  ...
  Settings, LogOut, ShieldCheck, Search, Wrench, BookLock, DollarSign, Receipt, FileText, BookOpen, Activity,
} from "lucide-react";
        ...
        <div style={{ padding: "6px 10px 4px", display: "flex", flexDirection: "column", gap: 2 }}>
          ...
          {isAdmin && (
            <>
              ...
              <NavItem to="/admin/transactions" label="Activity" icon={Activity} />
